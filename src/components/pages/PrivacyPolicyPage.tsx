...
const PrivacyPolicyPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg pt-24 pb-16">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-gray-50 dark:bg-dark-bg rounded-lg p-4 mb-4">
                ...
                <p className="text-gray-600 dark:text-gray-300">9/291 Vichitsongkram Road, Kathu, Phuket, Thailand</p>
                <p className="text-gray-600 dark:text-gray-300">Email: info@leader24.ai</p>
              </div>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-300 mt-4">
                ...
                <a href="mailto:info@leader24.ai" className="text-primary hover:underline">info@leader24.ai</a>
              </p>
            ...
            <section className="mb-4">
              ...
              <div className="bg-gray-50 dark:bg-dark-bg rounded-lg p-4">
                ...
                <p className="text-gray-600 dark:text-gray-300 mt-2">
                  <strong>{isItalian ? 'Indirizzo:' : 'Address:'}</strong>
                </p>
                <p className="text-gray-600 dark:text-gray-300">Sevedo Co. Ltd.</p>
                <p className="text-gray-600 dark:text-gray-300">9/291 Vichitsongkram Road</p>
                <p className="text-gray-600 dark:text-gray-300">Kathu, Phuket, Thailand</p>
              </div>
            </section>
          </div>
        </div>
